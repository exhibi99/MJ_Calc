<template>
    <div id="cal-input">
        <div class="form-group">
            ...
            <button @click="clearField('entryPrice')" class="clear-icon"><i class="bi bi-trash"></i></button>
        ...
        <div class="form-group">
            ...
            <button @click="clearField('stopLoss')" class="clear-icon"><i class="bi bi-trash"></i></button>
            <label class="formatted-label-loss">{{ formattedStopLoss }}</label>
        </div>
        <div class="form-group">
            <label for="investMoney"><i class="bi bi-wallet2"></i> 투자금</label>
            <input type="number" v-model.number="investMoney" id="investMoney" placeholder="현재시드를 입력하세요" @keyup.enter="handleEnter()">
            <button @click="clearField('investMoney')" class="clear-icon"><i class="bi bi-trash"></i></button>
